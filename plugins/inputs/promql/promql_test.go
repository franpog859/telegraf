	...
	}{
		{
			...
			expected: []telegraf.Metric{
				metric.New(
					"promql",
					map[string]string{},
					map[string]interface{}{"gauge": float64(3.14)},
					time.Unix(ts, 0),
					telegraf.Gauge,
				),
			},
		...
		},
		{
			...
			expected: []telegraf.Metric{
				...
				metric.New(
					...
					map[string]interface{}{"gauge": float64(23.0)},
					time.Unix(ts, 0),
					telegraf.Gauge,
				),
				metric.New(
					...
					map[string]interface{}{"gauge": float64(42.42)},
					time.Unix(ts, 0),
					telegraf.Gauge,
				),
			},
		 ...
		 */
		{
			...
			expected: []telegraf.Metric{
				metric.New(
					"matrix_metric",
					map[string]string{"job": "testing"},
					map[string]interface{}{"gauge": float64(1.1)},
					time.Unix(ts, 0),
					telegraf.Gauge,
				),
				metric.New(
					"matrix_metric",
					map[string]string{"job": "testing"},
					map[string]interface{}{"gauge": float64(2.2)},
				...
				metric.New(
					"matrix_metric",
					map[string]string{"job": "testing"},
					map[string]interface{}{"gauge": float64(3.3)},
...
func TestIntegrationInstant(t *testing.T) {
	...
	expected := []telegraf.Metric{
		metric.New(
			...
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(10)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests_total",
			map[string]string{"instance": "remote"},
			map[string]interface{}{"gauge": float64(1)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
	}
...
func TestIntegrationRange(t *testing.T) {
	...
	expected := []telegraf.Metric{
		...
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(30)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(80)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(210)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(550)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "localhost"},
			map[string]interface{}{"gauge": float64(1440)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
		...
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "remote"},
			map[string]interface{}{"gauge": float64(2)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
		...
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "remote"},
			map[string]interface{}{"gauge": float64(3)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
		metric.New(
			"test_http_requests",
			map[string]string{"instance": "remote"},
			map[string]interface{}{"gauge": float64(5)},
			time.Unix(0, 0),
			telegraf.Gauge,
		),
	}
